                ...
                area.innerHTML = `
                    ...
                    <div class="board-card-header" style="margin-bottom: 2rem; border-bottom: 1px solid var(--glass-border); padding-bottom: 1rem;">
                        ...
                        <div class="board-stats" style="font-size: 0.95rem;">
                            ...
                            <span style="cursor: pointer; transition: color 0.3s; font-variant-numeric: tabular-nums; ${heartColor}" onclick="likePost('${id}', this)" id="detailLikeBtn"><i class="${heartClass}"></i> <span id="detailLikeCnt">${currentPost.likes || 0}</span></span>
                        </div>
                    </div>
        ...
        window.likePost = async function(id, btnEl) {
            ...
            if (btnEl) {
                ...
                if (heartIcon) {
                    ...
                    // ê¸°ì¡´ ì• ë‹ˆë©”ì´ì…˜ í´ë˜ìŠ¤ ê¹”ë”íˆ ì œê±° í›„ ê°•ì œ ë¦¬í”Œë¡œìš°
                    heartIcon.classList.remove('animate-heart', 'animate-heart-cancel');
                    void heartIcon.offsetWidth; 
                    
                    if (currentlyLiked) {
                        // ì·¨ì†Œ ì‹œ: regularë¡œ ë³€ê²½ ë° cancel ì• ë‹ˆë©”ì´ì…˜ ë¶€ì—¬
                        heartIcon.classList.remove('fa-solid');
                        ...
                        // ì¶”ê°€ ì‹œ: solidë¡œ ë³€ê²½ ë° heart ì• ë‹ˆë©”ì´ì…˜ ë¶€ì—¬
                        heartIcon.classList.remove('fa-regular');
